...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 class="text-2xl font-bold mb-6">Edit Cleaning Schedule</h1>
        ...
        <form action="{{ route('cleaning_schedules.update', ['hotel' => $hotel->id, 'room' => $room->id, 'cleaningSchedule' => $cleaningSchedule->id]) }}" method="POST">
            ...
            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Update Schedule</button>
        </form>
    </div>
@endsection